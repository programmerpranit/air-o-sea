export default function Footer() {
  return (
    <div className="p-4 pt-6 bg-black text-white">
      <div className="">
        <h5 className="text-bold text-lg">About Us</h5>
        <p>
      ...
      <div className="my-4">
        <h5 className="text-bold text-lg">Newsletter</h5>
        <p>Subscribe our newsletter to get our latest update & news</p>
        <input
          className="w-full border-2 p-2 my-2 rounded-md"
      ...
      <div className="flex flex-col my-4 text-footer_text">
        ...
        <p className="text-center my-2">
          <a>hello@centuroglobal.com</a> | <a>T&C</a> | <a>Privacy Policy</a> | <a>FAQs</a> |
        </p>
        <div className="flex items-center justify-center my-2">
          <svg
          className="mx-2 bi bi-instagram"
